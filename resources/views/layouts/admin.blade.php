...
<head>
    ...
    <!-- Font Awesome -->
     ...
     {{ HTML::style('resources/assets/css/awesome.min.css') }}
    <!-- Ionicons -->
   
    {{ HTML::style('resources/assets/css/ionicons.min.css') }}
    <!-- daterange picker -->
    {{ HTML::style('resources/assets/css/daterangepicker-bs3.css') }}
   <!-- iCheck for checkboxes and radio inputs -->
    {{ HTML::style('resources/assets/css/all.css') }}
    <!-- Bootstrap Color Picker -->
    {{ HTML::style('resources/assets/css/bootstrap-colorpicker.min.css') }}
    <!-- Bootstrap time Picker -->
    {{ HTML::style('resources/assets/css/bootstrap-timepicker.min.css') }}
    <!-- Select2 -->
...
<header class="main-header">
    ...
    <!-- InputMask -->
    {{ HTML::script('resources/assets/js/jquery.inputmask.js') }}
    {{ HTML::script('resources/assets/js/jquery.inputmask.date.extensions.js') }}
    {{ HTML::script('resources/assets/js/jquery.inputmask.extensions.js') }}
    <!-- date-range-picker -->
    {{ HTML::script('resources/assets/js/moment.min.js') }}
    {{ HTML::script('resources/assets/js/daterangepicker.js') }}
    <!-- bootstrap color picker -->
    {{ HTML::script('resources/assets/js/bootstrap-colorpicker.min.js') }}
    <!-- bootstrap time picker -->
    {{ HTML::script('resources/assets/js/bootstrap-timepicker.min.js') }}
    <!-- SlimScroll 1.3.0 -->
    {{ HTML::script('resources/assets/js/jquery.slimscroll.min.js') }}
    <!-- iCheck 1.0.1 -->
    {{ HTML::script('resources/assets/js/icheck.min.js') }}
    <!-- FastClick -->
    {{ HTML::script('resources/assets/js/fastclick.min.js') }}
    <!-- AdminLTE App -->
    {{ HTML::script('resources/assets/js/app.min.js') }}
